...
const char *single_txt_vs = R"glsl(#version 320 es
...
const char *single_txt_fs = R"glsl(#version 320 es
precision mediump float;
in vec2 TextCoord;
...
const char *color_obj_vs = R"glsl(#version 320 es
...
const char *color_obj_fs = R"glsl(#version 320 es
varying vec3 Color;
varying vec2 Texcoord;
void main()
{
...
const char *modeling_vs = R"glsl(#version 320 es
precision mediump float;
...
const char *modeling_fs = R"glsl(#version 320 es
precision mediump float;
in vec3 FragPos;
in vec2 TextCoord;
in vec3 FragNormal;
...
const char *modeling_vs_col = R"glsl(#version 320 es
precision mediump float;
...
const char *modeling_fs_col = R"glsl(#version 320 es
precision mediump float;
in vec3 FragPos;
in vec3 FragNormal;
out vec4 o_clr;
...
const char *modeling_vs_col_d = R"glsl(#version 320 es
...
const char *modeling_fs_col_d = R"glsl(#version 320 es
precision highp float;
in vec3 FragPos;
in vec3 Normal;
...
const char *modeling_vs_1_txt = R"glsl(#version 320 es
precision mediump float;
layout (location = 0) in vec3 aPos;
layout (location = 1) in vec3 aNormal;
...
const char *modeling_fs_1_txt = R"glsl(#version 320 es
precision mediump float;
in vec3 FragPos;
in vec3 Normal;
in vec2 txtCoord;
