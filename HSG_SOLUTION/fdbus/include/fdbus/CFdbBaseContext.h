...
private:
    ...
    FdbEndpointId_t doRegisterEndpoint(CBaseEndpoint *endpoint);
    void doUnregisterEndpoint(CBaseEndpoint *endpoint);
    void callRegisterEndpoint(CMethodJob<CFdbBaseContext> *job, CBaseJob::Ptr &ref);
