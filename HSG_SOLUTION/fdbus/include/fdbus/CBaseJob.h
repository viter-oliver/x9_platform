...
protected:
    /*-----------------------------------------------------------------------------
     * Warning!!! This method is desprated!!! Never use it anymore!!!
     * Using void run(Ptr &ref) instead. To get the worker where the job
     * is running, using:
     *           ref->worker()
     *---------------------------------------------------------------------------*/
    virtual void run(CBaseWorker *worker, Ptr &ref) final
    {}
