...
{
public:
    void addNotifyItem(FdbMsgCode_t msg_code, const char *topic = 0, uint32_t flag = 0)
    {
    ...
    void addNotifyGroup(FdbEventGroup_t event_group, const char *topic = 0, uint32_t flag = 0)
    {
        addNotifyItem(fdbMakeGroupEvent(event_group), topic, flag);
    }
};
...
private:
    ...
    void callOnOnline(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callBindObject(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callConnectObject(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callUnbindObject(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callDisconnectObject(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callPrepareDestroy(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    ...
    void callDispOnOnline(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    ...
    void callWatchdogAction(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    ...
    void callRegisterConnNotification(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callRegisterMsgHandle(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callRegisterEventHandle(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
    void callRegisterSetEvtHandle(CMethodJob<CFdbBaseObject> *job, CBaseJob::Ptr &ref);
