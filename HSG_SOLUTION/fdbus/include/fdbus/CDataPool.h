...
public:
    ...
    // once enabled, events published by yourself will not be received even though the
    // events are subscribed.
    void enableNoReflect(bool active)
    {
        mNoReflect = active;
    }

    bool isNoReflectEnabled() const
    {
        return mNoReflect;
    }
...
private:
    ...
    void callCreateData(CMethodJob<CDataPool> *job, CBaseJob::Ptr &ref);
    void callDestroyData(CMethodJob<CDataPool> *job, CBaseJob::Ptr &ref);
    void callSubscribeData(CMethodJob<CDataPool> *job, CBaseJob::Ptr &ref);
    void callGetTopicList(CMethodJob<CDataPool> *job, CBaseJob::Ptr &ref);
