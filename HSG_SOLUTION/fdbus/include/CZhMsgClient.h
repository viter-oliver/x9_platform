...
public:
    ...
    int SyncCall(const int32_t msgId, const void* pInput, const int32_t inSize, RespItem* resp, int32_t timeout);

    int SyncCall(const int32_t msgId, const void* pInput, const int32_t inSize, int32_t timeout);

    int SyncCall(const int32_t msgId, google::protobuf::MessageLite &req, google::protobuf::MessageLite &resp, int32_t timeout);    

    int AsyncCall(const int32_t msgId, const void* pInput, const int32_t inSize);

    int SyncCall(const int32_t msgId, google::protobuf::MessageLite &message );
